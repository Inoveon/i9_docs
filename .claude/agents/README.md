...
Agentes especialistas para o repositório de documentação corporativa Inoveon/i9ON.
...
Produção de Documentos:
  ...
  doc-designer             ← design: HTML, SVG, layout, design system i9ON
...
doc-slides         doc-proposal          doc-report
   ↓                    ↓                     ↓
doc-designer      → implementa HTML + SVG (design system i9ON)
   ↓
...
| `doc-designer` | Design HTML | Implementa HTML + SVG com design system i9ON. Gráficos SVG puros, zero dependências externas |
